...
function getReactNodeRef(element) {
  if (!element || !React22.isValidElement(element)) {
    return null;
  }
...
function useDefaultProps({
  ...
  const ctx2 = React26.useContext(PropsContext);
...
function useCurrentColorScheme(options) {
  ...
  const setMode = React29.useCallback((mode2) => {
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider2(props) {
    ...
    const ctx2 = React30.useContext(ColorSchemeContext);
    ...
    const element = (0, import_jsx_runtime10.jsxs)(React30.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime10.jsx)(React30.Fragment, {
        children: (((_e = theme.generateStyleSheets) == null ? void 0 : _e.call(theme)) || []).map((styles, index2) => (0, import_jsx_runtime10.jsx)(GlobalStyles, {
          styles
        }, index2))
...
function useGlobalId(idOverride) {
  const [defaultId, setDefaultId] = React41.useState(idOverride);
...
var maybeReactUseId2 = React41["useId".toString()];
...
var SeriesContext = React45.createContext({
  isInitialized: false,
  data: {}
});
if (true) {
...
var PluginContext = React46.createContext({
  isInitialized: false,
  data: {
    colorProcessors: {},
    seriesFormatters: {},
...
function PluginProvider(props) {
  ...
  const formattedSeries = React47.useMemo(() => ({
    isInitialized: true,
...
function SeriesProvider(props) {
  ...
  const formattedSeries = React52.useMemo(() => ({
    isInitialized: true,
...
function useSeries() {
  const {
    isInitialized,
    data
  } = React53.useContext(SeriesContext);
  if (!isInitialized) {
...
function usePieSeries() {
  ...
  return React53.useMemo(() => series.pie, [series.pie]);
}
function useLineSeries() {
  const series = useSeries();
  return React53.useMemo(() => series.line, [series.line]);
}
function useBarSeries() {
  const series = useSeries();
  return React53.useMemo(() => series.bar, [series.bar]);
}
...
var CartesianContext = React54.createContext({
  isInitialized: false,
  data: {
    xAxis: {},
    yAxis: {},
...
function CartesianProvider(props) {
  ...
  const xValues = React57.useMemo(() => computeValue({
    drawingArea,
    formattedSeries,
    axis: xAxis,
  ...
  const yValues = React57.useMemo(() => computeValue({
    drawingArea,
    formattedSeries,
    axis: yAxis,
...
var InteractionContext = React59.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React59.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React59.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
var HighlightedContext = React60.createContext({
  isInitialized: false,
  data: {
...
function useHighlighted() {
  const {
    isInitialized,
    data
  } = React61.useContext(HighlightedContext);
  if (!isInitialized) {
...
function useControlled2({
  ...
  } = React62.useRef(controlled !== void 0);
  const [valueState, setValue] = React62.useState(defaultProp);
  ...
  const setValueIfUncontrolled = React62.useCallback((newValue) => {
    if (!isControlled) {
      setValue(newValue);
    }
  }, []);
...
function HighlightedProvider({
  ...
  const [highlightedItem, setHighlightedItem] = useControlled2({
  ...
  const series = useSeries();
  const seriesById = React63.useMemo(() => {
  ...
  const providerValue = React63.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
...
var ZAxisContext = React64.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React64.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
...
function useChartId() {
  ...
  return React66.useMemo(() => chartId, [chartId]);
}
...
function useChartGradient() {
  ...
  return React71.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
var ChartsSurface = React73.forwardRef(function ChartsSurface2(inProps, ref) {
  ...
  return (0, import_jsx_runtime28.jsxs)(ChartChartsSurfaceStyles, _extends({
    width: width2,
    height: height2,
    ...
    children: [(0, import_jsx_runtime28.jsx)("title", {
      children: title
    }), (0, import_jsx_runtime28.jsx)("desc", {
      children: desc
    }), children]
  }));
});
...
var ChartContainer = React76.forwardRef(function ChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime29.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime29.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime29.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime29.jsx)(CartesianProvider, _extends({}, cartesianProviderProps, {
          children: (0, import_jsx_runtime29.jsx)(ZAxisContextProvider, _extends({}, zAxisContextProps, {
            children: (0, import_jsx_runtime29.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime29.jsx)(HighlightedProvider, _extends({}, highlightedProviderProps, {
                children: (0, import_jsx_runtime29.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
...
var useEnhancedEffect2 = typeof window !== "undefined" ? React77.useLayoutEffect : React77.useEffect;
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  const displayError = React78.useRef(false);
  const rootRef = React78.useRef(null);
  const [width2, setWidth] = React78.useState(0);
  const [height2, setHeight] = React78.useState(0);
  const computeSize = React78.useCallback(() => {
...
var ResponsiveChartContainer = React79.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
  } = useResponsiveChartContainerProps(props, ref);
  return (0, import_jsx_runtime30.jsx)(ResizableContainer, _extends({}, resizableChartContainerProps, {
    children: hasIntrinsicSize ? (0, import_jsx_runtime30.jsx)(ChartContainer, _extends({}, chartContainerProps)) : null
  }));
});
...
var elementAcceptingRef2 = chainPropTypes2(import_prop_types26.default.element, acceptingRef2);
elementAcceptingRef2.isRequired = chainPropTypes2(import_prop_types26.default.element.isRequired, acceptingRef2);
...
var elementTypeAcceptingRef_default2 = chainPropTypes2(import_prop_types27.default.elementType, elementTypeAcceptingRef2);
...
var refType2 = import_prop_types28.default.oneOfType([import_prop_types28.default.func, import_prop_types28.default.object]);
...
function ChartsText(props) {
  ...
  const wordsByLines = React87.useMemo(() => getWordsByLines({
    style: style4,
  ...
  return (0, import_jsx_runtime31.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style: style4,
    children: wordsByLines.map((line2, index2) => (0, import_jsx_runtime31.jsx)("tspan", {
      x: x2,
...
true ? ChartsText.propTypes = {
   ...
   */
  lineHeight: import_prop_types29.default.number,
  /**
   * If `true`, the line width is computed.
   * @default false
   */
  needsComputation: import_prop_types29.default.bool,
   ...
   * Text displayed.
   */
  text: import_prop_types29.default.string.isRequired
} : void 0;
...
function useMounted(defer = false) {
  const [mountedState, setMountedState] = React88.useState(false);
  useEnhancedEffect_default2(() => {
    if (!defer) {
...
function ChartsXAxis(inProps) {
  ...
  return (0, import_jsx_runtime32.jsxs)(AxisRoot, {
    transform: `translate(0, ${position3 === "bottom" ? top3 + height2 : top3})`,
    className: classes.root,
    sx,
    children: [!disableLine && (0, import_jsx_runtime32.jsx)(Line, _extends({
      x1: left3,
      x2: left3 + width2,
      ...
      return (0, import_jsx_runtime32.jsxs)("g", {
        ...
        children: [!disableTicks && showTick && (0, import_jsx_runtime32.jsx)(Tick, _extends({
          y2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && showTickLabel && (0, import_jsx_runtime32.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
    ...
    }), label && (0, import_jsx_runtime32.jsx)("g", {
      className: classes.label,
      children: (0, import_jsx_runtime32.jsx)(Label, _extends({}, labelRefPoint, axisLabelProps, {
        text: label
      }))
    })]
  });
...
function ChartsYAxis(inProps) {
  ...
  return (0, import_jsx_runtime33.jsxs)(AxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime33.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime33.jsxs)("g", {
        ...
        className: classes.tickContainer,
        children: [!disableTicks && (0, import_jsx_runtime33.jsx)(Tick, _extends({
          x2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime33.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime34.jsxs)(React91.Fragment, {
    children: [topId && (0, import_jsx_runtime34.jsx)(ChartsXAxis, _extends({}, topAxisProps, {
      position: "top",
      axisId: topId
    })), bottomId && (0, import_jsx_runtime34.jsx)(ChartsXAxis, _extends({}, bottomAxisProps, {
      position: "bottom",
      axisId: bottomId
    })), leftId && (0, import_jsx_runtime34.jsx)(ChartsYAxis, _extends({}, leftAxisProps, {
      position: "left",
      axisId: leftId
    })), rightId && (0, import_jsx_runtime34.jsx)(ChartsYAxis, _extends({}, rightAxisProps, {
      position: "right",
      axisId: rightId
    }))]
  });
...
var Portal = React92.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  } = props;
  const [mountNode, setMountNode] = React92.useState(null);
  ...
  if (disablePortal) {
    if (React92.isValidElement(children)) {
      ...
      return React92.cloneElement(children, newProps);
    }
    return (0, import_jsx_runtime35.jsx)(React92.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime35.jsx)(React92.Fragment, {
...
var PopperTooltip = React93.forwardRef(function PopperTooltip2(props, forwardedRef) {
  const {
    anchorEl,
    children,
    direction,
  ...
  const tooltipRef = React93.useRef(null);
  const ownRef = useForkRef(tooltipRef, forwardedRef);
  const popperRef = React93.useRef(null);
  const handlePopperRef = useForkRef(popperRef, popperRefProp);
  const handlePopperRefRef = React93.useRef(handlePopperRef);
  useEnhancedEffect_default(() => {
    handlePopperRefRef.current = handlePopperRef;
  }, [handlePopperRef]);
  React93.useImperativeHandle(popperRefProp, () => popperRef.current, []);
  const rtlPlacement = flipPlacement(initialPlacement, direction);
  const [placement, setPlacement] = React93.useState(rtlPlacement);
  const [resolvedAnchorElement, setResolvedAnchorElement] = React93.useState(resolveAnchorEl(anchorEl));
  React93.useEffect(() => {
...
var Popper = React93.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children,
...
true ? DefaultPropsProvider2.propTypes = {
   ...
   * @ignore
   */
  value: import_prop_types36.default.object.isRequired
} : void 0;
...
var Popper3 = React97.forwardRef(function Popper4(inProps, ref) {
  const isRtl = useRtl();
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime41.jsx)(React98.Fragment, {
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React99.useState(null);
  React99.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function ChartsItemTooltipContent(props) {
  ...
  const {
    zAxis,
    zAxisIds
  } = React101.useContext(ZAxisContext);
...
var TypographyRoot = styled_default2("span", {
  ...
  return {
    ...
    variants: [{
      ...
      style: value
    })), ...Object.entries(theme.palette).filter(([, value]) => value && value.main).map(([color3]) => ({
      props: {
        color: color3
      },
      style: {
...
var Typography = React102.forwardRef(function Typography2(inProps, ref) {
  const {
    color: color3,
    ...themeProps
  } = useDefaultProps2({
  ...
  return (0, import_jsx_runtime44.jsx)(TypographyRoot, {
    as: Component,
    ref,
    className: clsx_default(classes.root, className),
    ...other,
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React104.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React104.useMemo(() => {
...
function LegendPerItem(props) {
  ...
  const isRtl = useRtl();
  const drawingArea = useDrawingArea();
  const labelStyle = React106.useMemo(
  ...
  const padding2 = React106.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React106.useCallback((label, inStyle = {}) => {
    const style4 = _objectWithoutPropertiesLoose(inStyle, _excluded10);
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React106.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React106.useMemo(() => {
...
true ? DefaultChartsLegend.propTypes = {
   ...
   */
  drawingArea: import_prop_types43.default.shape({
    bottom: import_prop_types43.default.number.isRequired,
    height: import_prop_types43.default.number.isRequired,
    left: import_prop_types43.default.number.isRequired,
    right: import_prop_types43.default.number.isRequired,
    top: import_prop_types43.default.number.isRequired,
    width: import_prop_types43.default.number.isRequired
  }).isRequired,
  /**
  ...
  series: import_prop_types43.default.object.isRequired,
  seriesToDisplay: import_prop_types43.default.arrayOf(import_prop_types43.default.shape({
...
function useAxis({
  ...
  const {
    zAxis,
    zAxisIds
  } = React109.useContext(ZAxisContext);
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime51.jsxs)(React110.Fragment, {
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'middle'
   */
  align: import_prop_types45.default.oneOf(["end", "middle", "start"]),
  /**
   ...
   * @default '50%'
   */
  length: import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string]),
  /**
   ...
   */
  maxLabel: import_prop_types45.default.oneOfType([import_prop_types45.default.func, import_prop_types45.default.string]),
  /**
   * The label to display at the minimum side of the gradient.
   * Can either be a string, or a function.
   * @default ({ formattedValue }) => formattedValue
   */
  minLabel: import_prop_types45.default.oneOfType([import_prop_types45.default.func, import_prop_types45.default.string]),
  /**
   * The position of the legend.
   */
   ...
   * @default 'linear'
   */
  scaleType: import_prop_types45.default.oneOf(["linear", "log", "pow", "sqrt", "time", "utc"]),
  /**
   * The space between the gradient bar and the labels.
   * @default 4
   */
  spacing: import_prop_types45.default.number,
  /**
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default false
   */
  hideFirst: import_prop_types46.default.bool,
  /**
   * Hide the last item of the legend, corresponding to the [max, +infinity] piece.
   * @default false
   */
  hideLast: import_prop_types46.default.bool,
  /**
   * Space between two legend items (in px).
   * @default 10
   */
   ...
   */
  labelFormatter: import_prop_types46.default.func,
  /**
   * Style applied to legend labels.
   * @default theme.typography.subtitle1
   */
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime53.jsxs)(React112.Fragment, {
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime54.jsx)(StyledText, _extends({
    x: left3 + width2 / 2,
    y: top3 + height2 / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime55.jsx)(StyledText2, _extends({
    x: left3 + width2 / 2,
    y: top3 + height2 / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime56.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime56.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
@mui/system/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-WZV2R3P5.js.map
