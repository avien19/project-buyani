...
var maybeReactUseId2 = React39["useId".toString()];
...
var useChartDimensions = (width2, height2, margin2) => {
  ...
  const drawingArea = React40.useMemo(() => ({
...
var DrawingContext = React41.createContext({
  top: 0,
  left: 0,
  bottom: 0,
  right: 0,
...
var SvgContext = React41.createContext({
  isInitialized: false,
  data: {
    current: null
  }
...
function DrawingProvider(props) {
  ...
  const isPointInside = React41.useCallback(({
    x: x2,
    y: y2
  }, options) => {
  ...
  const value = React41.useMemo(() => _extends({
    chartId: chartId ?? ""
  }, drawingArea, {
    isPointInside
  }), [chartId, drawingArea, isPointInside]);
  const refValue = React41.useMemo(() => ({
    isInitialized: true,
    data: svgRef
  }), [svgRef]);
...
var InteractionContext = React42.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React42.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
...
function PluginProvider(props) {
  ...
  return (0, import_jsx_runtime20.jsx)(PluginContext.Provider, {
...
function SeriesProvider(props) {
  ...
  return (0, import_jsx_runtime21.jsx)(SeriesContext.Provider, {
    value: formattedSeries,
    children
  });
}
...
function usePieSeries() {
  ...
  return React52.useMemo(() => series.pie, [series.pie]);
}
...
function useBarSeries() {
  const series = useSeries();
  return React52.useMemo(() => series.bar, [series.bar]);
}
...
function CartesianProvider(props) {
  ...
  const xValues = React56.useMemo(() => computeValue({
    drawingArea,
    formattedSeries,
    axis: xAxis,
  ...
  const yValues = React56.useMemo(() => computeValue({
    drawingArea,
    formattedSeries,
    axis: yAxis,
...
function useChartId() {
  const {
    chartId
  } = React57.useContext(DrawingContext);
  return React57.useMemo(() => chartId, [chartId]);
}
...
var ZAxisContext = React58.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React58.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
...
true ? ZAxisContextProvider.propTypes = {
   ...
   */
  zAxis: import_prop_types21.default.arrayOf(import_prop_types21.default.shape({
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime24.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime24.jsxs)(React61.Fragment, {
  ...
  return (0, import_jsx_runtime26.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime26.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse2,
          scale,
          colorScale,
          colorMap,
...
var HighlightedContext = React64.createContext({
  isInitialized: false,
  data: {
...
function useControlled2({
  ...
  } = React66.useRef(controlled !== void 0);
  const [valueState, setValue] = React66.useState(defaultProp);
  ...
  const setValueIfUncontrolled = React66.useCallback((newValue) => {
    if (!isControlled) {
      setValue(newValue);
    }
  }, []);
...
function HighlightedProvider({
  ...
  const series = useSeries();
  const seriesById = React67.useMemo(() => {
  ...
  const providerValue = React67.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
  ...
  return (0, import_jsx_runtime27.jsx)(HighlightedContext.Provider, {
    value: providerValue,
    children
  });
}
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react16.forwardRef)((givenProps, givenRef) => {
    ...
    return React68.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React69.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React69.createContext(init));
...
var ChartContainer = React75.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
...
var useEnhancedEffect2 = typeof window !== "undefined" ? React76.useLayoutEffect : React76.useEffect;
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  const displayError = React77.useRef(false);
  const rootRef = React77.useRef(null);
  const [width2, setWidth] = React77.useState(0);
  const [height2, setHeight] = React77.useState(0);
...
function ChartsText(props) {
  ...
  const wordsByLines = React86.useMemo(() => getWordsByLines({
    style: style4,
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime34.jsxs)(React90.Fragment, {
...
var Portal = React91.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  } = props;
  const [mountNode, setMountNode] = React91.useState(null);
  ...
  if (disablePortal) {
    if (React91.isValidElement(children)) {
      ...
      return React91.cloneElement(children, newProps);
    }
    return (0, import_jsx_runtime35.jsx)(React91.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime35.jsx)(React91.Fragment, {
...
var PopperTooltip = React92.forwardRef(function PopperTooltip2(props, forwardedRef) {
  const {
    anchorEl,
    children,
    direction,
  ...
  const popperRef = React92.useRef(null);
  const handlePopperRef = useForkRef(popperRef, popperRefProp);
  const handlePopperRefRef = React92.useRef(handlePopperRef);
  useEnhancedEffect_default(() => {
    handlePopperRefRef.current = handlePopperRef;
  }, [handlePopperRef]);
  React92.useImperativeHandle(popperRefProp, () => popperRef.current, []);
  const rtlPlacement = flipPlacement(initialPlacement, direction);
  const [placement, setPlacement] = React92.useState(rtlPlacement);
  const [resolvedAnchorElement, setResolvedAnchorElement] = React92.useState(resolveAnchorEl(anchorEl));
  React92.useEffect(() => {
...
var Popper = React92.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children,
...
function NoSsr(props) {
  ...
  const [mountedState, setMountedState] = React97.useState(false);
  useEnhancedEffect_default(() => {
    if (!defer) {
      setMountedState(true);
    }
  ...
  return (0, import_jsx_runtime41.jsx)(React97.Fragment, {
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React98.useState(null);
  React98.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
var Typography = React101.forwardRef(function Typography2(inProps, ref) {
  const {
    color: color3,
    ...themeProps
  } = useDefaultProps2({
...
function ChartsAxisTooltipContent(props) {
  ...
  const {
    zAxisIds,
    zAxis
  } = React103.useContext(ZAxisContext);
  const series = useSeries();
  const colorProcessors = useColorProcessor();
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React103.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React103.useMemo(() => {
...
@mui/system/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MU6MREJC.js.map
